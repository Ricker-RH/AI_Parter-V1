-- Run as the database owner after creating five LOGIN roles in Neon.
-- Example:
-- psql "$DATABASE_URL" \
...
--   -v rate_limiter_login_role=aifans_rate_limiter_login \
...
\else
  ...
  \quit
\endif
\if :{?rate_limiter_login_role}
\else
  \echo 'rate_limiter_login_role is required'
  \quit
\endif
...
GRANT aifans_rate_limiter TO :"rate_limiter_login_role";
