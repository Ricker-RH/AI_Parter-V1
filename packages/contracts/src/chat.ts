...
export const ChatConversationSummarySchema = z.strictObject({id: uuid, ipProfile: ChatIpIdentitySchema, lastMessage: ChatLastMessageSchema.nullable(), updatedAt: dateTime, sendEnabled: z.boolean()})
...
export const ChatMessageSchema = z.strictObject({id: uuid, role: ChatMessageRoleSchema, body: ChatBodySchema, deliveryState: ChatMessageDeliveryStateSchema, createdAt: dateTime})
