...
describe('public search page', () => {
  ...
  it('keeps the current cursor in post interaction return paths', async () => {
    ...
    expect(screen.getByRole('link', {name: 'Like 0'})).toHaveAttribute('href', expect.stringContaining(encodeURIComponent('/en/search?q=luna&category=posts&cursor=abc_DEF-123')))
  })
