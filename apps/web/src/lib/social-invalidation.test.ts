...
describe('social mutation invalidation', () => {
  it('maps only fixed post mutations to the existing locale feed tags', () => {
    ...
    expect(socialMutationTags({method: 'PUT', path: 'posts/22222222-2222-4222-8222-222222222222/bookmark'})).toEqual(['feed:for_you:en', 'feed:for_you:zh-CN'])
    expect(socialMutationTags({method: 'DELETE', path: 'posts/22222222-2222-4222-8222-222222222222/bookmark'})).toEqual(['feed:for_you:en', 'feed:for_you:zh-CN'])
    expect(socialMutationTags({method: 'POST', path: 'posts/22222222-2222-4222-8222-222222222222/share'})).toEqual(['feed:for_you:en', 'feed:for_you:zh-CN'])
