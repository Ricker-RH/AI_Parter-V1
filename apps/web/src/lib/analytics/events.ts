...
export function trackLandingViewed(analytics: AnalyticsClient, properties: {locale: Locale; routeName: AnalyticsRouteName}) {
  safelyCapture(analytics, createAnalyticsEvent('landing_viewed', {locale: properties.locale, route_name: properties.routeName}))
}

export function trackSignUpStarted(analytics: AnalyticsClient, properties: {locale: Locale; actionSource?: AnalyticsActionSource}) {
...
export function trackSignInStarted(analytics: AnalyticsClient, properties: {locale: Locale; actionSource?: AnalyticsActionSource}) {
...
export function trackCreatorCenterViewed(analytics: AnalyticsClient, properties: {locale: Locale; routeName: AnalyticsRouteName}) {
...
export function trackIpCreationStepViewed(analytics: AnalyticsClient, properties: {locale: Locale; creationStep: AnalyticsCreationStep}) {
...
export function trackGenerationRequested(analytics: AnalyticsClient, properties: {locale: Locale; visualType: AnalyticsVisualType}) {
...
export function trackMasterImageSelected(analytics: AnalyticsClient, properties: {locale: Locale; visualType: AnalyticsVisualType}) {
...
export function trackSubmissionClicked(analytics: AnalyticsClient, properties: {locale: Locale; creationStep: AnalyticsCreationStep}) {
