...
type ProfileFollowButtonProps = {profileId:string;following:boolean;labels:Pick<SocialLabels,'follow'|'followingAction'|'interactionError'>;locale:Locale;onFollowingChange?(following:boolean):void;viewerScope:string}
...
function ScopedProfileFollowButton({profileId,following,labels,locale,onFollowingChange}: ProfileFollowButtonProps) {
