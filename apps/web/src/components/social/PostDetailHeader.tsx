...
export function PostDetailHeader({labels, locale, postId, referrer, viewCount}: {labels: PostDetailHeaderLabels; locale: Locale; postId: string; referrer?: string; viewCount?: number}) {
