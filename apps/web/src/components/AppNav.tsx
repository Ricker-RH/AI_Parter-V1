...
export interface ShellLabels extends MoreMenuLabels { primary: string; home: string; forYou?: string; following?: string; search: string; notifications: string; messages: string; bookmarks: string; profile: string; settings: string; creatorNav: string; creatorCenter?: string; activity?: string; myProfile?: string; expandNavigation?: string; recommendations: string; recommendationsEmpty: string }
type IconComponent = ComponentType<SVGProps<SVGSVGElement>>
type NavItem = {key: keyof Pick<ShellLabels, 'forYou' | 'following' | 'search' | 'notifications' | 'messages' | 'bookmarks' | 'profile' | 'creatorNav'>; href: string; icon: IconComponent}
