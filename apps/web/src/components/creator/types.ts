...
export interface CreatorLabels {
  eyebrow:string;title:string;description:string;newIdentity:string;emptyTitle:string;emptyDescription:string;drafts:string;identities:string;loading:string;unavailable:string;authRequired:string
...
export interface CreatorAdminLabels {eyebrow:string;title:string;description:string;submissions:string;requests:string;emptySubmissions:string;emptyRequests:string;loading:string;unavailable:string;currentIdentity:string;proposedIdentity:string;approve:string;reject:string;reason:string;reasonRequired:string;updated:string;decisionError:string}
